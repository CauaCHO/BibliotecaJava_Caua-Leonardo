...
public class LivroDAO {
    ...
    public void inserir(Livro livro) {
        String sql = "INSERT INTO livros (nome_livro, isbn, autor, email, data_publicacao, valor_livro) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public List<Livro> listarTodos() {
        ...
        String sql = "SELECT id, nome_livro, isbn, autor, email, data_publicacao, valor_livro FROM livros ORDER BY id DESC";
    ...
    public List<Livro> pesquisar(String termo) {
        List<Livro> livros = new ArrayList<>();
        String sql = "SELECT id, nome_livro, isbn, autor, email, data_publicacao, valor_livro " +
    ...
    public Livro buscarPorId(int id) {
        String sql = "SELECT id, nome_livro, isbn, autor, email, data_publicacao, valor_livro FROM livros WHERE id = ?";
    ...
    public void atualizar(Livro livro) {
        String sql = "UPDATE livros SET nome_livro = ?, isbn = ?, autor = ?, email = ?, data_publicacao = ?, valor_livro = ? WHERE id = ?";
